...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_FORMBOT_TREX_2
#endif
...
#define HOTEND_OFFSET_X {0.0, 33.5} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 96, 96 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 2, 25, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 400, 4000, 4000 }
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER -5      // NB: should be -5.5 but new macro doesn't allow float
